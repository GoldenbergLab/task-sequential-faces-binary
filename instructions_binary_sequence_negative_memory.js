/**
Instructions for Sequential Task With Memory Block
**/
...
var  instruction_seq_MainTaskTransition = {
  ...
  "<p align='left'> In the following section you will complete the actual session, which consists of 25 trials. This part of the study should take 10 minutes, more or less. </p>" +
...
var  instruction_mem4 = {
  type: "html-button-response",
  choices: ['Continue'],
  stimulus:  "<p> Remember, the goal here is to provide YOUR JUDGEMENT OF</p>"+
   "<p> <strong> WHICH OF THE TWO PRESENTED FACES WAS</strong></p>" +
